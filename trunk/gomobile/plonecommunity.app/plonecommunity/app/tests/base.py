...
def setup_product():
    ...
    import plonecommunity.app
    zcml.load_config('configure.zcml', plonecommunity.app)
    ...
    ztc.installPackage('plonecommunity.app')
...
setup_product()
ptc.setupPloneSite(products=['plonecommunity.app'])
