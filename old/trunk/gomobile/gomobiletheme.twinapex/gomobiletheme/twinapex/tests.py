...
def setup_zcml():
    ...
    import gomobiletheme.twinapex
    zcml.load_config('configure.zcml', gomobiletheme.twinapex)
    ...
    ztc.installPackage('gomobiletheme.twinapex')



# The order here is important.
setup_zcml()
ptc.setupPloneSite(products=['gomobile.mobile', "gomobiletheme.twinapex"])
...
class ThemeTestCase(BaseTestCase):
    ...
    def test_installed(self):
        ...
        self.assertEqual(mobile_properties.mobile_skin, "Plone Go Mobile Twinapex Theme")
    ...
    def test_load_resource(self):
        ...
        file = "++resource++gomobiletheme.twinapex/logo.png"

        self.browser.open(self.portal.absolute_url() +"/" + file)
        self.assertEqual(self.browser.headers["content-type"], "image/png")
