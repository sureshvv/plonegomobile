...
def setup_zcml():
    ...
    import gomobiletheme.mobipublic
    zcml.load_config('configure.zcml', gomobiletheme.mobipublic)
    ...
    ztc.installPackage('gomobiletheme.mobipublic')


# The order here is important.
setup_zcml()
ptc.setupPloneSite(products=['gomobile.mobile', "gomobiletheme.mobipublic"])
...
class BaseTestCase(base.BaseTestCase):
    ...
    def getProductName(self):
        return "gomobiletheme.mobipublic"
